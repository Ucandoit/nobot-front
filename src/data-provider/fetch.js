...
var _HttpError = require('ra-core/lib/dataProvider/HttpError');
...
exports.fetchJson = function fetchJson(url) {
...
exports.queryParameters = _queryString.stringify;
...
exports.flattenObject = function flattenObject(value) {
